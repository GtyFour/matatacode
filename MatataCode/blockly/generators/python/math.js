...
Blockly.Python.addReservedWords('math,random,Number,backward,forward,turnleft,turnright,wait,led_left,led_right,song,playsong');
...
Blockly.Python['song'] = function(block) {
    var value_name = Blockly.Python.valueToCode(block, 'NAME', Blockly.Python.ORDER_ATOMIC);
    // TODO: Assemble Python into code variable.
    var code = '...\n';
    return code;
...
Blockly.Python['playsong'] = function(block) {
