...
class HoriViewController: UIViewController, WKNavigationDelegate, UIScrollViewDelegate,CBCentralManagerDelegate, CBPeripheralDelegate{
    ...
    func loadWebView() {
        //读取主页面
        if let htmlUrl = Bundle.main.url(forResource: "hori_code", withExtension: "html", subdirectory: "MatataCodeView") {
